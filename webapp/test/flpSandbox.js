		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#ApprovePurchaseOrder-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ApprovePurchaseOrder-display": {
								"semanticObject": "ApprovePurchaseOrder",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ux.masterdetail",
									"url": sap.ui.require.toUrl("ux/masterdetail")
								}
							}
						}
					}
