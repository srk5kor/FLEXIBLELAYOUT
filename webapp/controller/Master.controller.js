sap.ui.define([
	...
	return BaseController.extend("ux.masterdetail.controller.Master", {
		...
		onSearch : function (oEvent) {
			...
			if (sQuery) {
				this._oListFilterState.aSearch = [new Filter("OrderedById", FilterOperator.Contains, sQuery)];
			} else {
		...
		onOpenViewSettings : function (oEvent) {
			...
			if (!this.byId("viewSettingsDialog")) {
				Fragment.load({
					...
					name: "ux.masterdetail.view.ViewSettingsDialog",
					controller: this
